...
try {
  ...
  // From/To
  $mail->setFrom('daydreamcollectiveart@gmail.com', 'Day Dream Collective'); // match your Gmail
  $mail->addAddress('daydreamcollectiveart@gmail.com', 'Day Dream Collective'); // where you receive
